...
<div class="asd">
    ...
    <form class="form-horizontal" action="{{route('editProduct',[$product->id])}}" method="POST" enctype="multipart/form-data">
        {{-- {{ csrf_field() }} --}}
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                @csrf
                <input id="product_name" name="price" value="{{ $product->price }}" class="form-control input-md" required="" type="text">
