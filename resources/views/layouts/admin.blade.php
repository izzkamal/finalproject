            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('indexProducts')}}"
                                aria-expanded="false"><span class="hide-menu">All Products</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('addProduct')}}"
                                aria-expanded="false"><span class="hide-menu">Add Product</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{route('addCategorie')}}" aria-expanded="false"><span class="hide-menu">Add
                                    Categorie</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('messages')}}"
                                aria-expanded="false"><span class="hide-menu">Messages</span></a>
                        </li>
